# -*- coding: utf-8 -*-
"""
Created on Mon Dec 27 22:03:14 2021
...
save_base_path = os.path.join(base_path, 'label_2')
...
stock_info[['ts_code', 'open', 'trade_date', 'ts_date_id', 'label_max', 'label_min','label_final']].to_csv(save_path, index=None)
